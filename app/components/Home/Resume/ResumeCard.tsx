        ...
        <div className="flex items-center space-x-6 bg-blue-950/20 transition-all duration-300 p-4 sm:p-8 rounded-md">
            ...
            <div className="flex-1">
                ...
                <p className="text-gray-300 text-sm sm:text-base pt-3">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Consequatur, corrupti tempora ut quam eligendi repellendus quo velit mollitia accusantium quidem, qui dolore vero distinctio doloremque animi aliquid! Quaerat, facere accusantium?
                </p>
            </div>
        </div>
    </div>
