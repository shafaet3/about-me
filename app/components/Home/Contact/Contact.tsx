...
const Contact = () => {
    return (
        <section id="contact" className='scroll-mt-24 pt-16 pb-16'>
            <div className='w-[90%] md:w-[80%] lg:w-[70%] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-center'>
                ...
                <div>
                    ...
                    <div className="mt-7">
                        <div className="flex items-center space-x-3 mb-4">
                            ...
                            <p className="text-xl font-bold text-gray-400">+880 1961343996</p>
                        </div>
                        <div className="flex items-center space-x-3 mb-4">
                            <BiEnvelope className='w-9 h-9 text-cyan-300' />
                            <p className="text-xl font-bold text-gray-400">shafaet3@gmail.com</p>
                        </div>
                        <div className="flex items-center space-x-3 mb-4">
                ...
                data-aos="zoom-in">
                    ...
                    <textarea
                        ...
                        className='px-4 py-3.5 mt-6 bg-[#363659] text-white outline-none rounded-md w-full h-32 resize-none placeholder:text-white/70'
                    ></textarea>
